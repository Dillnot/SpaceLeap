...
public class Player {
	 ...
	 * @param screenMiddle - center of screen for y position
	 */
	...
	public void setX(int direction) { 
		switch (direction)
	     ...
	     case -2:  
	    	 {
	    		 if (x - 6.0f >= 0) x-= 6f; break;
	    	 }
	     case -1:
	     {
	    	     if(x - 3f >= 0 ) x -= 3f; break;
	     }
	     case  1:  
	    	 {
	    		 if (x + 3f <= 640 - 32) x+=3.0f; break;
	    	 }
	     case  2: 
	    	 {
	    		 if (x + 6f <= 640 - 32) x+=6.0f; break;
	    	 }
	     }
	 ...
	 */
	public void reset() { this.x = screenMiddle; } 
	 ...
	 * @param award - increase score. Pass award = 0 if bullet misses or hits a wall
	 */
